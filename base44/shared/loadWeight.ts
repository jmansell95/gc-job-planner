/**
 * Shared weight & axle-load helpers — reused by commitBasketSignOut (backend)
 * and the frontend load planner / driver hub / manifests so the safe-to-drive
 * logic stays consistent everywhere.
 */
...
export function getPayloadStatus(loadedKg: number, maxKg?: number | null): PayloadStatus {
 ...
 */
export function calculateAxleGuidance(items: WeightedItem[], vehicle?: VehicleSpec | null) {
