...
export const CAPABILITY_KEYS = [
  ...
  { key: 'scheduling', label: 'Scheduling', description: 'Scheduling hub and rota management' },
  ...
  { key: 'log-qc', label: 'Log QC', description: 'Review investigation logs' },
  { key: 'billing', label: 'Billing', description: 'View billing and invoicing' },
  { key: 'teams', label: 'Teams', description: 'Manage crews and team structure' },
