...
export const ROLE_SECTIONS = {
  admin: ['overview', 'jobs', 'rota', 'calendar', 'timesheets', 'compliance', 'insights', 'finance', 'teams', 'settings'],
  manager: ['overview', 'jobs', 'rota', 'calendar', 'timesheets', 'compliance', 'insights', 'finance'],
