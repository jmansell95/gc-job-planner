...
export const ROLE_SECTIONS = {
  super_admin: ['overview', 'jobs', 'rota', 'calendar', 'scheduling', 'logistics', 'timesheets', 'compliance', 'log-qc', 'audit-trail', 'teams', 'billing', 'settings', 'ags-import', 'safety', 'safety-hub', 'assets', 'vehicles', 'project-financials'],
  admin: ['overview', 'jobs', 'rota', 'calendar', 'scheduling', 'logistics', 'timesheets', 'compliance', 'log-qc', 'audit-trail', 'teams', 'billing', 'settings', 'ags-import', 'safety', 'safety-hub', 'assets', 'vehicles', 'project-financials'],
  management: ['overview', 'jobs', 'rota', 'calendar', 'scheduling', 'logistics', 'timesheets', 'compliance', 'log-qc', 'audit-trail', 'billing', 'safety', 'safety-hub', 'assets', 'vehicles', 'project-financials'],
...
export function canAccessRoute(profile, isPlatformAdmin, path) {
  ...
  if (role === 'field') {
    return path === '/staff-schedule' || path === '/staff-profile';
  }
