        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200 sticky top-0 bg-white rounded-t-2xl z-10">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Scan to view, service, book or print</p>
            </div>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button onClick={() => setPassportAsset(match)}
                  className="flex flex-col items-center gap-1.5 p-3 bg-slate-800 hover:bg-slate-900 text-white rounded-xl transition">
                ...
                <button onClick={() => setShowBookVehicle(true)}
                  className="flex flex-col items-center gap-1.5 p-3 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl transition">
              ...
              {showServiceForm && (
                <div className="rounded-xl border border-amber-200 bg-amber-50/40 p-3.5 space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={() => setShowServiceForm(false)} className="p-1 text-slate-400 hover:bg-white rounded"><X className="w-4 h-4" /></button>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea value={serviceForm.notes} onChange={e => setServiceForm(p => ({ ...p, notes: e.target.value }))} rows={2}
                      placeholder="Findings, defects, parts replaced…" className="w-full px-2.5 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-emerald-600 resize-none" />
                  </div>
                  <button onClick={handleSaveService} disabled={savingService}
                    className="w-full inline-flex items-center justify-center gap-1.5 px-4 py-2.5 bg-amber-600 text-white rounded-lg text-sm font-semibold hover:bg-amber-700 transition disabled:opacity-60">
