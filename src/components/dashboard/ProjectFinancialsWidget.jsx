...
// Project Financials — rolls up earned / invoiced / unbilled across every job
// linked to a project. Earned combines billable cost items (rig & plant day rates
// from the project rate card) with chargeable investigation logs (auto-priced
// driller remarks, e.g. EWR borehole advance & mobilisation SOR lines), giving
// Finance a single live total per project.
export default function ProjectFinancialsWidget() {
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="flex-1 px-2.5 py-1.5 border border-slate-200 rounded-lg text-sm font-semibold text-slate-700 focus:outline-none focus:border-[#2E5A1A] bg-white"
            >
