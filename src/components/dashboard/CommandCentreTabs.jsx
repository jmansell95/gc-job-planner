...
export default function CommandCentreTabs({ activeId, onChange, className = '' }) {
  return (
    <div className={`mb-4 ${className}`}>
      <div className="flex gap-1 bg-slate-900/95 backdrop-blur-md rounded-2xl border border-slate-800 shadow-lg p-1.5">
          ...
          return (
            <React.Fragment key={p.id}>
              ...
              <button
                ...
                className={`flex-1 min-w-0 flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-5 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm font-bold transition-all active:scale-[0.98] ${
                  active
