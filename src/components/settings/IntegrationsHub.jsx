...
const INTEGRATIONS = [
  ...
  { id: 'dvla-ves', name: 'DVLA Vehicle Enquiry', category: 'Fleet & Vehicles', icon: Search, color: 'bg-violet-100 text-violet-600', settingKey: 'dvla_ves_config', connectedField: 'api_key', desc: 'Official DVLA API — accurate make, fuel type, colour, year & MOT expiry by registration plate' },
