...
// Simulated dashboard preview items — what a user with the current matrix would see
...
export default function AccessMatrixEditor() {
  ...
  // Fetch manifests for the selected division
  ...
  // Fetch staff for the selected division (to show who is affected)
  ...
  // Compute the diff: only store overrides that differ from the base group
  const computeDiff = () => {
