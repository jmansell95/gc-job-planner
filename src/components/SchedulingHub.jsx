    ...
    <div>
      <div className="flex items-center justify-between gap-3 mb-4 flex-wrap">
        ...
        <button onClick={openChat} type="button"
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-700 text-white text-sm font-medium hover:bg-emerald-800 active:scale-[0.98] transition shadow-sm touch-manipulation select-none">
