...
export default function CalendarView() {
  ...
  return (
    <div>
      {/* Hero header */}
      <div className="hero-gradient relative overflow-hidden rounded-2xl mb-5">
        <div className="relative px-5 md:px-7 py-5 md:py-6">
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-emerald-100 text-xs md:text-sm mt-0.5">Everything scheduled & booked — at a glance</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-4 gap-2 md:gap-3 mt-4">
            {[
              { label: 'Events', value: monthEvents.length, icon: Calendar },
