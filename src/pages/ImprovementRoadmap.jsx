...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { priority: 'medium', title: 'Biometric login (Face ID / Touch ID)', desc: 'Fast, secure authentication without re-entering passwords on mobile devices. The WebAuthn API is available on modern browsers. PWA install to home screen enables biometric unlock on iOS/Android. Full implementation requires platform-level auth integration — the browser\'s built-in credential manager and autofill already streamline the login experience.', status: 'done' },
