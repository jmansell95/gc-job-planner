...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      { priority: 'high', title: 'Asset utilization trends', desc: 'New Utilization tab on the Asset Hub shows a 30-day utilization trend chart (on-site vs idle per day) with average utilization rate and under-utilized asset count. Top 5 most utilized assets listed with progress bars. Helps identify idle assets for reallocation or sale.', status: 'done' },
